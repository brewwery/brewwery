...
export const APP_VERSION = "0.7.1-beta.2";
export const APP_CHANNEL = "Private Beta";
...
export const RELEASE_NOTES_URL = "https://github.com/brewwery/brewwery/releases/tag/v0.7.1-beta.2";
